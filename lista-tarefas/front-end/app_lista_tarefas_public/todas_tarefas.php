	...
	<head>
		...
		<script>
			...
			function editar(){
				...
				inputTarefa.className = 'form-control' //classe do bootstrap



				//Crari um button para envio do form
				let button = document.createElement('button')
				button.type = 'submit'
				button.className = 'btn btn-info'
				button.innerHTML = 'Atualizar' //texto interno


				//Incluir inputTarefa no form
				form.appendChild(inputTarefa)	//insere um elemento filho ao elemento pai
